<template>
  <div>
    ...
    <editer-charge-commission
      :isSidebarActive="addNewDataSidebar"
      @closeSidebar="toggleDataSidebar"
      @reload='getExchangeRate'
      :data="sidebarData"
    />
    ...
    <!-- <vx-card code-toggler> -->
      ...
      <div class="vx-card p-6">
        <div class="flex flex-wrap items-center">
          ...
          <vs-button @click="addNewData" v-if="total == 0">添加</vs-button>
        </div>
      </div>
...
<script>
import EditerChargeCommission from "./EditerChargeCommission.vue";
// import DelFrame from "@/components/DelFrame.vue"
export default {
  components: {
    EditerChargeCommission
    // DelFrame
  },
  data() {
    return {
  ...
  methods: {
    getExchangeRate(){
      let _this = this;
      _this.$axios({
          url: "/admin/Setting/getInviteInfo",
          method: "post",
          data:{},
        }).then((res) => {
