  ...
  <div class="table-set t-s">
    ...
    <!-- <vx-card code-toggler> -->
      ...
      <vs-table stripe :data="set">
        <template slot="thead">
          <vs-th>备注</vs-th>
          <vs-th>AccessKeyId</vs-th>
          <vs-th>AccessKeySecret</vs-th>
          <vs-th>Endpoint</vs-th>
          <vs-th>Bucket</vs-th>
          <vs-th>状态</vs-th>
...
export default {
  ...
  methods: {
    ...
    change(tr){
        let _this = this;
      _this.$axios({
        url:'/admin/Setting/editStorageStatus',
        method: "post",
        data:{
          id:tr.id,
          status:tr.status
