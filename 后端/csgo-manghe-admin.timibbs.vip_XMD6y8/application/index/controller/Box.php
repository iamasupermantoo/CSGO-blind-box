...
//                        dump("区间内、区间下限以下，不限，至少存在两个的情况,".$t."饰品价格在 $boxPrice 以下");
        ...
        if($total_recharge>=0){
            ...
            if($typeStr == 'open'){
                ...
                $currplayerInfo = Db::table('player')
                    ->where('id', $player_id)
                    ->find();
                ...
                foreach ($this->player_skin as $k=>$v){
                    ...
                    $this->player_skin[$k]['lxdh'] = $currplayerInfo['lxdh'];
                    $this->player_skin[$k]['lxpeople'] = $currplayerInfo['lxpeople'];
                    $this->player_skin[$k]['tradeurl'] = $currplayerInfo['tradeUrl'];
...
//                                ->setDec('stock_group',1);
            ...
            $player_skins_info['lxdh'] = $playerInfo['lxdh'];
            $player_skins_info['lxpeople'] = $playerInfo['lxpeople'];
            $player_skins_info['tradeurl'] = $playerInfo['tradeUrl'];
